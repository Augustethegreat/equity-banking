...
function Simulateur() {
  ...
  return (
    <div className='bg-[#fff]'>
        ...
        <div className='flex mt-[60px] text-black text-[14px] font-medium  lg:max-w-screen-lg mx-auto items-center bg-[#fff]'>
            <div className=" w-full md:px-[60px] shadow-xl pb-8 rounded-[10px] px-4 block md:flex gap-x-[50px] bg-[#fff]">
              <div className=' bg-[#fff] space-y-4 md:space-y-8 md:w-[430px] w-full'>
              <div className='bg-[#fff] block md:flex gap-x-[30px] w-full px-4 md:w-auto'>
