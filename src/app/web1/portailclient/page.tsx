...
import pic from "../img/2048x2048pxOK.jpg"
...
export default function Portailclient() {
  return (
    <div  className='text-center items-center justify-center flex mx-auto pb-[50px] text-black overflow-x-hidden bg-[#fff]'>
    <div  className='text-center items-center justify-center mx-auto'>
      ...
      <div className='block lg:flex gap-x-[100px] mt-[20px] px-5 md:px-0'>
       ...
       <div className='h-auto lg:h-[600px] items-center justify-center mx-auto mt-0'>
